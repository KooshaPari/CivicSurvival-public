...
- Full UI dev-tree audit reports 7 findings (1 low, 6 high); production-only audit is clean. CI blocks high production findings and publishes the dev-tree result for remediation.
