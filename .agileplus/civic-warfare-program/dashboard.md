...
1. PR #87 (WP02-A) is the open work-in-progress. Once merged, prepare a successor PR for **WP02-B (FlatBuffers end-to-end cross-language round-trip)** on the next branch off `origin/main`:
...
4. Resolve the pre-existing C# solution NuGet "Invalid framework identifier" error (out of scope for PR #87; recorded for the next housekeeping PR after PR #87 lands).
